...
const zh_CN: i18nObject = {
    ...
    updatelog: "FF14手游中，如果第一次没有完美探索，则下次到达该地点，需触发全部完美条件才会显示金球。<br>视频攻略请参考：<a href='https://www.bilibili.com/video/BV1fVK8z2Ewb' target='_blank'>https://www.bilibili.com/video/BV1fVK8z2Ewb</a>",
    introdution: {
        text: "本指南将会计算艾欧泽亚大陆上的天气情况以匹配将来符合天气和时间条件从而能够完成的探索笔记。<br>本指南将会在有新的探索笔记可以完成时通过浏览器右下角通知的形式告知您，您可以点击该通知来直接地返回到该页面。（需要您的浏览器支持通知功能）<br>点击卡片右上角可以切换完成/未完成状态。",
        button: "我知道了",
    },
    notification: {
        welcome: {
